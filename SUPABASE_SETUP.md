...
This guide sets up Supabase for Political Ideology Profiler on Vercel (React + Vite frontend + serverless API routes).
...
1. In Supabase dashboard, create two projects:
   - `political-ideology-profiler-dev`
   - `political-ideology-profiler-prod`
