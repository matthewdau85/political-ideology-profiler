...
## 6.1) Auth → profile auto-provisioning
Apply migration `supabase/migrations/20260307_002_auth_profile_trigger.sql` so new Auth users automatically get a `public.profiles` row.
