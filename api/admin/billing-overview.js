...
function secureTokenDigest(value) {
...
function isAdminAuthorized(req) {
  ...
  const incomingDigest = secureTokenDigest(bearer);
  const configuredDigest = secureTokenDigest(configuredToken);
  return crypto.timingSafeEqual(incomingDigest, configuredDigest);
}
